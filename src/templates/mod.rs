...
pub const AIRIS_BEGIN_MARKER: &str = "<!-- BEGIN GENERATED BY AIRIS - DO NOT EDIT -->";
pub const AIRIS_END_MARKER: &str = "<!-- END GENERATED BY AIRIS -->";
...
impl TemplateEngine {
    ...
    pub fn render_claude_md(&self, manifest: &Manifest) -> Result<String> {
        ...
        Ok(format!("{}\n\n{}\n\n{}", AIRIS_BEGIN_MARKER, body, AIRIS_END_MARKER))
    }
...
"#;
        ...
        assert!(result.contains(AIRIS_BEGIN_MARKER));
        assert!(result.contains(AIRIS_END_MARKER));
