...
// Dockerfile templates loaded from templates/hbs/ via include_str!
const NEXTJS_DOCKERFILE: &str = include_str!("../templates/hbs/Dockerfile.nextjs.hbs");
const NODE_DOCKERFILE: &str = include_str!("../templates/hbs/Dockerfile.node.hbs");
const BUN_DOCKERFILE: &str = include_str!("../templates/hbs/Dockerfile.bun.hbs");
const DENO_DOCKERFILE: &str = include_str!("../templates/hbs/Dockerfile.deno.hbs");
const EDGE_DOCKERFILE: &str = include_str!("../templates/hbs/Dockerfile.edge.hbs");
const RUST_DOCKERFILE: &str = include_str!("../templates/hbs/Dockerfile.rust.hbs");
const PYTHON_DOCKERFILE: &str = include_str!("../templates/hbs/Dockerfile.python.hbs");
