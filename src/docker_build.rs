...
"#,
        ...
        port = crate::conventions::framework_defaults("nextjs").port,
    )
}
...
"#,
        ...
        node_version = node_version,
        extra_args = extra_args,
        port = crate::conventions::framework_defaults("node").port,
    )
}
...
"#,
        ...
        image = image,
        extra_args = extra_args,
        port = crate::conventions::framework_defaults("cloudflare-worker").port,
    )
}
...
"#,
        ...
        app_name = app_name,
        extra_args = extra_args,
        rust_image = crate::channel::defaults::RUST_IMAGE,
        port = crate::conventions::framework_defaults("rust").port,
    )
}
...
"#,
        target = target,
        extra_args = extra_args,
        python_image = crate::channel::defaults::PYTHON_IMAGE,
        port = crate::conventions::framework_defaults("python").port,
    )
}
