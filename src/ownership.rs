...
pub fn get_ownership(path: &Path) -> Ownership {
    ...
    match path_str.as_ref() {
        ...
        // CI/CD workflows, Dockerfile, compose.yml, and .env.example
        // are project-owned (not generated by airis)
        ...
        _ => {
            ...
            if path_str.starts_with(".github/workflows/") {
                ...
                if let Ok(content) = std::fs::read_to_string(path)
                    && content.starts_with("# Auto-generated by airis gen")
                {
                ...
                && path_str.ends_with("/package.json")
            {
                ...
                Ownership::User
            } else if path_str.starts_with("traefik/") || path_str.starts_with("types/") {
                Ownership::User
...
mod tests {
    ...
    fn test_tool_owned_files() {
        ...
        assert_eq!(
            get_ownership(Path::new(".github/workflows/nonexistent.yml")),
            Ownership::User
        );
    }
    ...
    fn test_hybrid_files() {
        ...
        assert_eq!(
            get_ownership(Path::new("libs/ui/package.json")),
            Ownership::Hybrid
        );
    }
    ...
    fn test_user_owned_files() {
        ...
        assert_eq!(
            get_ownership(Path::new("tsconfig.build.json")),
            Ownership::User
        );
        assert_eq!(
            get_ownership(Path::new("eslint.config.mjs")),
            Ownership::User
        );
    }
    ...
    fn test_default_is_user() {
        ...
        assert_eq!(
            get_ownership(Path::new("some/nested/path.json")),
            Ownership::User
        );
    }
